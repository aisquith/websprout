...
<meta name="ws-build" content="2026-06-10-r263">
<script>window._wsBuild="2026-06-10-r263";console.log("%c[Websprout] build 2026-06-10-r263 — nav-contrast now covers the whole header, so a logo outside the nav is fixed too","color:#4ade80;font-weight:700")</script>
...
const BUILD_ID = '2026-06-10-r263';
