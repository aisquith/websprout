...
<meta name="ws-build" content="2026-06-10-r268">
<script>window._wsBuild="2026-06-10-r268";console.log("%c[Websprout] build 2026-06-10-r268 — strips leaked CSS text that the AI dumps into the page body","color:#4ade80;font-weight:700")</script>
...
const BUILD_ID = '2026-06-10-r268';
