...
function withReveal(html){
  ...
  var _both = NAV_CONTRAST_SCRIPT + CTA_EDGE_SCRIPT + REVEAL_SCRIPT;
...
<meta name="ws-build" content="2026-06-10-r244">
<script>window._wsBuild="2026-06-10-r244";console.log("%c[Websprout] build 2026-06-10-r244 — CTA edge enforcer: solid buttons never blend into an adjacent section","color:#4ade80;font-weight:700")</script>
...
const BUILD_ID = '2026-06-10-r244';
