...
<meta name="ws-build" content="2026-06-10-r136">
<script>window._wsBuild="2026-06-10-r136";console.log("%c[Websprout] build 2026-06-10-r136 (fix root cause = output length: tighter ~520-line target + signature moves trimmed to 5 core (marquee/countup/bento now optional), thinking set to 3072 with the freed-up time)","color:#4ade80;font-weight:700")</script>
...
const BUILD_ID = '2026-06-10-r136';
