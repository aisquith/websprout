...
function withReveal(html){
  ...
  var _both = NAV_CONTRAST_SCRIPT + CTA_EDGE_SCRIPT + NAV_DEDUPE_SCRIPT + TEXT_CONTRAST_SCRIPT + PRODUCT_MODAL_SCRIPT + REVEAL_SCRIPT;
...
<meta name="ws-build" content="2026-06-10-r264">
<script>window._wsBuild="2026-06-10-r264";console.log("%c[Websprout] build 2026-06-10-r264 — price field auto-formats to $, cart restyled, and cart loads when the store editor opens","color:#4ade80;font-weight:700")</script>
...
const BUILD_ID = '2026-06-10-r264';
