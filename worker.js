...
function withReveal(html){
  ...
  var _both = NAV_CONTRAST_SCRIPT + CTA_EDGE_SCRIPT + NAV_DEDUPE_SCRIPT + TEXT_CONTRAST_SCRIPT + PRODUCT_MODAL_SCRIPT + CATEGORY_TABS_SCRIPT + HEADER_FIX_SCRIPT + REVEAL_SCRIPT;
...
<meta name="ws-build" content="2026-06-10-r267">
<script>window._wsBuild="2026-06-10-r267";console.log("%c[Websprout] build 2026-06-10-r267 — header-layout enforcer: clean flex header on every site so nav items never overlap","color:#4ade80;font-weight:700")</script>
...
const BUILD_ID = '2026-06-10-r267';
