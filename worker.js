...
<meta name="ws-build" content="2026-06-10-r259">
<script>window._wsBuild="2026-06-10-r259";console.log("%c[Websprout] build 2026-06-10-r259 — store preview repaints after saving products, so the grid shows them immediately","color:#4ade80;font-weight:700")</script>
...
(function(){
  ...
  function doSave(){
    ...
    .then(function(j){
      ...
      try{ if(j&&j.products) window._wsProducts=j.products; if(typeof setPreview==="function") setPreview(gHTML); }catch(e){}
    })
...
const BUILD_ID = '2026-06-10-r259';
