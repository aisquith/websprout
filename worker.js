...
- NO WHITE BAND BELOW THE FOOTER — the browser must never show a strip of the html/body background beneath the last section of the page. If the footer is dark, the html AND body backgrounds MUST match the footer color. Concretely: set html,body { background: <the footer color>; margin: 0; padding: 0; min-height: 100%; } and ensure the <footer> is the LAST element in <body> with NO trailing margin, padding, or empty element below it. On short pages (little content, tall viewport) this rule is what prevents a visible band of the page background showing under the footer, which is a common and unacceptable failure.
...
<script>window._wsBuild="2026-06-10-r232";console.log("%c[Websprout] build 2026-06-10-r233 — PROMPT: no white band below footer on short pages","color:#4ade80;font-weight:700")</script>
