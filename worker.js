...
function withReveal(html){
  ...
  var _both = NAV_CONTRAST_SCRIPT + CTA_EDGE_SCRIPT + NAV_DEDUPE_SCRIPT + TEXT_CONTRAST_SCRIPT + PRODUCT_MODAL_SCRIPT + CATEGORY_TABS_SCRIPT + REVEAL_SCRIPT;
